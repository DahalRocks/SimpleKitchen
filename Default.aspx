<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="KitCalc._Default" %>
                     ...
                     success: function(data) {
                         if (data.d.length == 0) {
                             ...
                             $.each(data.d, function(index, item) {
                                 location.href = "ProgramFiles/MainMenu.aspx";
                             });
                    ...
                    <tr>
                        <td>
                            <input type="button" class="button" value="ok" /></td>
                                <td><a href="ProgramFiles/Signup.aspx">sign up</a>
                        </td>
                    </tr>
                </table>
            </div>
